...
# ssr_basecost_detail=[[0,0] for x in range(15)]
# bahamut_basecost_detail=[[0,0] for x in range(15)]
# print(ssr_lvlup_cost_v1)
# print(bahamut_lvlup_cost)
# print(ssr_basecost_detail)
# print(bahamut_basecost_detail)
...
print('ssr_lvlup_cost_v1',ssr_lvlup_cost_v1)
print('ssr_lvlup_cost_v1',ssr_basecost_detail_v1)
...
for x in range(1,15):
    print('lv',x,'->lv',x+1,'所需',bahamut_ssr_list[x],'该级成本',bahamut_basecost_detail[x],'合计',bahamut_basecost_detail_sum[x])
